...
return [
    ...
    */
    ...
    'max' => [
        'array' => 'Поле :attribute должно содержать максимум :max элемент(ов).',
    ...
    'min' => [
        'array' => 'Поле :attribute должно содержать минимум :min элемент(ов).',
        'file' => 'Поле :attribute должно быть больше :min килобайт.',
    ...
    'numeric' => 'Поле :attribute должно быть численным.',
    'password' => [
