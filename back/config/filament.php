...
return [
    ...
    */
    ...
    'pages' => [
        'namespace' => 'App\\Http\\ApiV1\\AdminApi\\Filament\\Pages',
        'path' => app_path('Http/ApiV1/AdminApi/Filament/Pages'),
        'register' => [
    ...
    */
    ...
    'resources' => [
        ...
        'path' => app_path('Http/ApiV1/AdminApi/Filament/Resources'),
        'register' => [],
    ],
    ...
    */
    ...
    'widgets' => [
        'namespace' => 'App\\Http\\ApiV1\\AdminApi\\Filament\\Widgets',
        'path' => app_path('Http/ApiV1/AdminApi/Filament/Widgets'),
        'register' => [
    ...
    */
    ...
    'livewire' => [
        'namespace' => 'App\\Http\\ApiV1\\AdminApi\\Filament',
        'path' => app_path('Http/ApiV1/AdminApi/Filament'),
    ],
